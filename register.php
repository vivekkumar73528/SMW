      ...
      <nav class="navbar">
        ...
        <div class="nav-Links">
          <ul class="nav-links">
            ...
            <li class="dropdown"><a href="../SMW/Phone SKin/Login/Login.html">Login</a></li>
          </ul>
          </li>
        </div>
        ...
        <div class="sign-img">
          <div class="par">
            ...
            <p>We are provide you best service.</p><img src="/SMW/Phone Skin/Assets/SIGNUP.png" alt="">
          </div>
        </div>
        <div class="main">
          <h1>User Account</h1>
...
?>
          ...
          <?php endif;
?>
          <form method="post"><label for="username">Username:</label><input type="text" id="username" name="username"
              required><label for="email">Email:</label><input type="email" id="email" name="email" required><label
              for="password">Password:</label><input type="password" id="password" name="password" required><button
              type="submit">Create</button>
            <div class="signup-option"><a href="login.php">Already have an account? Login</a></div>
          </form>
        </div>
